...
# This model is the attention model (Attention-2),
# trained with the 5-char dataset withe top-2000 frequency character.
...
def main():
    ...
    print model.summary()
    # global out
    # out = codecs.open("../result/result_r", 'w', 'utf-8')
    ...
    for iteration in range(1, 100):
        ...
        # if the prediction does not include "R"
        # it will a valid prediction

        # In the attention_2 it
        # while c < 1:
        while c < 3:
            s1 = sentence
        ...
        # out.write("\n")
        if count == 10:
            model.save_weights("../weight/keras_wr_10")
        elif count == 20:
            model.save_weights("../weight/keras_wr_20")
        elif count == 30:
            model.save_weights("../weight/keras_wr_30")
        elif count == 40:
            model.save_weights("../weight/keras_wr_40")
        elif count == 50:
            model.save_weights("../weight/keras_wr_50")
        elif count == 60:
            model.save_weights("../weight/keras_wr_60")
        elif count == 70:
            model.save_weights("../weight/keras_wr_70")
        elif count == 80:
            model.save_weights("../weight/keras_wr_80")
        elif count == 90:
            model.save_weights("../weight/keras_wr_90")
        elif count == 100:
            model.save_weights("../weight/keras_wr_100")
    # out.flush()
    # out.close()
